...
public class MainForAssembler {
	...
	private static Assembler assembler = new Assembler();  // Assembler 객체 생성. Assembler사용할 객체가 모두 생성됨.
	...
	private static void processNewCommand(String[] arg) {   // 새로운 회원 정보 생성.
			...
			MemberRegisterService regSvc = assembler.getMemberRegisterService(); // Assembler 객체 사용1
	...
	private static void processChangeCommand(String[] arg) { // 암호 변경 기능 메소드.
		...
		ChangePasswordService changePwdSvc =
				assembler.getChangePasswordService();   // 패스워드 바꾸는 메소드. Assembler 객체사용2
